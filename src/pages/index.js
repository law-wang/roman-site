      ...
      <div id="text">
        <span id="intro" className="highlight">
          ...
          <span
            ...
            onClick={(e) =>
              alert(
                'Maybe: Computer Science and Economics, and Political Science'
              )
            }
          >
            this
          ...
          <span
            ...
            onClick={(e) =>
              alert(
                'Maybe: the intersection between design and computing, song lyrics, room sprays, Chinese poems, grand strategy games, interior design, Cities Skylines, floor plans'
              )
            }
          >
            these
