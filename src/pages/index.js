...
const Text = () => {
  ...
  return (
    <>
      <div>
        <span id="intro" style={{whiteSpace:"pre-wrap", padding: "1px 0 1px 0"}} className="highlight">Lawrence Wang studis Computer Science, Political Science, and Economics at Yale and is intersted in the intersction of design and computing. He aspires to be somone who draws, codes, and writes. </span>
      </div>
